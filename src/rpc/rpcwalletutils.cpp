...
//            if( AvailableFromStatus(retrieve_status) && ((retrieve_status & MC_OST_STORAGE_MASK) == MC_OST_OFF_CHAIN ))
            if( AvailableFromStatus(retrieve_status) )
            {
                ...
                {        
                    ...
                    if(pBitChainFilterEngine->RunStreamFilters(wtx,stream_output,(unsigned char *)stream_id,filter_block,filter_offset, 
                              ...
                              string *strError)
{
    ...
    {
        *strError="Offchain data is not supported with this wallet version. To get this functionality, run \"bitchaind -walletdbversion=2 -rescan\"";
