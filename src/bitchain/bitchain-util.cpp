...
//                    err=params->Create(mc_gState->m_Params->m_Arguments[1],version);
                ...
                { 
                    ...
                    printf("You can edit it in %s before running bitchaind for the first time.\n\n",fileName);
                    printf("To generate blockchain please run \"bitchaind %s -daemon\".\n",params->Name());
                }                
                else
                {
...
*/        
    ...
    if(err == MC_ERR_OPERATION_NOT_SUPPORTED)
    {
        ...
        printf("Usage:\n");
        printf("  bitchain-util create <blockchain-name>  ( <protocol-version> = %d ) [options]        Creates new bitchain configuration file %s with default parameters\n",
        ...
        printf("  bitchain-util clone <old-blockchain-name> <new-blockchain-name> [options]               Creates new bitchain configuration file %s copying parameters\n",fileName);
