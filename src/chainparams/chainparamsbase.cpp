...
class CBaseBitChainParams : public CBaseTestNetParams
{
public:
    CBaseBitChainParams()
    {
...
static CBaseBitChainParams multiChainParams;
/* MCHN END */      
...
bool SelectBitChainBaseParams(const char *NetworkName,int RPCPort)
{
