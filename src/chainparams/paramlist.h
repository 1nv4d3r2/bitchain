...
#ifndef BITCHAINPARAMLIST_H
#define BITCHAINPARAMLIST_H
...
static const mc_OneBitchainParam BitchainParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: bitchain (permissions, native assets) or bitcoin"},
...
*/                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for bitchaind and bitchain-cli."},                   
