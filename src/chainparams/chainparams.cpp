...
class CBitChainParams : public CMainParams {
public:
    CBitChainParams() {    };
    
    void SetFixedParams(const char *NetworkName)
    {
        networkID = CBaseChainParams::BITCHAIN;
...
//        convertSeed6(vFixedSeeds, pnSeed6_test, ARRAYLEN(pnSeed6_test));
    ...
    void SetBitChainParam(const char*param_name,int64_t value)
    {
...
static CBitChainParams multiChainParams;


bool SelectBitChainParams(const char *NetworkName)
{
    SelectBitChainBaseParams(NetworkName,(int)mc_gState->m_NetworkParams->GetInt64Param("defaultrpcport"));
...
void SetBitChainParams()
{
    multiChainParams.SetBitChainParams();
}

void SetBitChainParam(const char*param_name,int64_t value)
{
    multiChainParams.SetBitChainParam(param_name,value);
}


void SetBitChainRuntimeParams()
{
    multiChainParams.SetBitChainRuntimeParams();
}

bool InitializeBitChainParams()
{
